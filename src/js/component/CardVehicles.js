...
const CardVehicles = ({
    ...
    return ( <
        ...
        <
        p className = "card-text" > < span className = "fw-bolder" > Clase de Vehiculo: < /span> {claseVehiculo} </p >
        <
        ...
        <
        /Link> <
        button className = "btn btn-outline border-warning border-3 text-warning"
        onClick = {
            () => actions.addFavourites(name, id, "vehiculo")
        } >
        <
        i className = {
            `${store.favoritoVehiculo[id] ? " fw-bolder" : " "} far fa-heart`
        } > < /i> <
        /button> <
        /div> <
        /div> <
